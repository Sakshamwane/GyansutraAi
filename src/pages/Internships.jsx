...
import '../components/InternshipCTA.css';
  ...
  return (
    <div className="training-page">
      <div className="container">
        {/* Premium Internship Hero Section */}
        <section className="internship-hero-section section">
          <div className="container">
              ...
              <div className="cta-grid">
                <div className="cta-content animate-fade-in-up">
                  ...
                  <h1 className="cta-title">
                    ...
                    <span className="gradient-text">Campus and Corporate.</span>
                  </h1>
                  ...
                  <div className="hero-actions">
                    ...
                    <button className="btn btn-secondary btn-lg ml-4">View Syllabus</button>
                  </div>
                </div>
                ...
                <div className="cta-image-wrapper animate-fade-in-up delay-200">
                  <div className="image-experience-badge">
                    ...
                    <span className="badge-text">Industry Choice</span>
                  </div>
                  <img
